...
\subsection{Sesgos}
El caso Amazon es un ejemplo de estudio sobre sesgo algorítmico de tipo histórico: el modelo aprendió de un conjunto de datos que reflejaba una desigualdad estructural preexistente (la infrarrepresentación de mujeres en puestos técnicos) y la reprodujo, e incluso la amplificó, presentándola bajo una apariencia de objetividad matemática \cite{raghavan2020,chen2023}. A este sesgo histórico se sumó un sesgo de selección de variables (o ``sesgo de diseño''), derivado de las decisiones técnicas sobre qué características del currículum debían influir en la puntuación final.
